                        ...
                        <div class="card-body">
                            <form method="post"
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="inputLastName">Persentase Biaya Simpan</label>
    ...
    <script>
        ...
        $(function() {
            const hitung_ulang = function() {
                ...
                let biaya_simpan = ($('input[name="harga_barang"]').val() * persentase) / 100;
                $("#biaya_simpan").val(biaya_simpan);
            ...
            $('input[name="harga_barang"]').on("input", function() {
                hitung_ulang();
            });
            $("#biaya_pesan").on("input", function() {
                hitung_ulang();
            });
