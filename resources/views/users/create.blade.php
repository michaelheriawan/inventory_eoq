            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('pengambil.store') }}">
                                @csrf
                                <!-- Form Row-->
                                <div class="row gx-3 mb-3">
                                    <!-- Form Group (first name)-->
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="inputFirstName">Nama Pengambil</label>
                                ...
                                <!-- Submit button-->
                                <button class="btn btn-primary" type="submit">Tambah Pengambil</button>
                            </form>
                        </div>
                    </div>
                </div>
